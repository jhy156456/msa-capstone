...
from PolicyHandler import wheneverBookmarkRegistered_SendRegisterBookmark
from PolicyHandler import wheneverBookmarkCanceled_SendCancelBookmark
...
def consume(msg):
    ...
    if data['eventType'] == "BookmarkRegistered":
        wheneverBookmarkRegistered_SendRegisterBookmark(data)
    if data['eventType'] == "BookmarkCanceled":
        wheneverBookmarkCanceled_SendCancelBookmark(data)
